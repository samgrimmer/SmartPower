...
{
    public partial class TActivityManagement
    {
        public TActivityManagement()
        {
            TActivityManagementActions = new HashSet<TActivityManagementAction>();
        }
        ...
        public int? AmOrgQuId { get; set; }
        public string AmFormulatedDescription { get; set; }
        public bool? AmReportToClient { get; set; }

        public virtual ICollection<TActivityManagementAction> TActivityManagementActions { get; set; }
    }
}
